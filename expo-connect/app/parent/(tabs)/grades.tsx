...
const styles = StyleSheet.create({
  ...
  title: { ...ParentType.h1, color: CampusColors.onSurface, marginBottom: ParentSpace.md },
  summary: {
    flexDirection: 'row',
  ...
  summaryLabel: { ...ParentType.label, color: 'rgba(255,255,255,0.85)' },
  summaryValue: { ...ParentType.stat, color: CampusColors.onPrimary, marginTop: 4 },
  tabs: { flexDirection: 'row', gap: 8, marginBottom: ParentSpace.md, flexWrap: 'wrap' },
  tab: {
  ...
  tabText: { ...ParentType.label, color: CampusColors.onSurfaceVariant },
  ...
  courseTeacher: { ...ParentType.bodyMd, color: CampusColors.onSurfaceVariant, marginTop: 2 },
  courseGrade: { fontFamily: CampusFonts.bodyBold, fontSize: 22, color: CampusColors.primary },
  coursePct: { ...ParentType.caption, color: CampusColors.onSurfaceVariant, marginTop: 2 },
  grid2: { flexDirection: 'row', flexWrap: 'wrap', marginTop: ParentSpace.sm, gap: 8 },
  metricCell: {
    width: '48%',
  ...
  metricLabel: { ...ParentType.caption, color: CampusColors.onSurfaceVariant },
  metricVal: { ...ParentType.bodyMd, fontFamily: CampusFonts.bodySemiBold, color: CampusColors.onSurface, marginTop: 4 },
  commentBox: {
    flexDirection: 'row',
    gap: 10,
    ...
    borderRadius: CampusRadius.sm,
    padding: ParentSpace.md,
    marginTop: ParentSpace.sm,
    alignItems: 'flex-start',
  },
  commentText: { flex: 1, ...ParentType.bodyMd, color: CampusColors.onSurface },
  trendCard: {
    backgroundColor: CampusColors.surfaceContainerLowest,
    borderRadius: CampusRadius.md,
    padding: ParentSpace.md,
  ...
  cardTitle: { ...ParentType.h2, color: CampusColors.onSurface, marginBottom: ParentSpace.sm },
  ...
  barLabel: { ...ParentType.caption, color: CampusColors.onSurfaceVariant, marginTop: 8 },
  insight: {
    flexDirection: 'row',
    gap: 10,
  ...
  insightText: { flex: 1, ...ParentType.bodyMd, color: CampusColors.onTertiaryFixedVariant },
  finalsCard: {
    borderWidth: 2,
    borderStyle: 'dashed',
  ...
  finalsTitle: { ...ParentType.h2, color: CampusColors.onSurface, textAlign: 'center' },
  finalsSub: { ...ParentType.bodyMd, color: CampusColors.onSurfaceVariant, textAlign: 'center', marginTop: 6 },
  finalsBtn: {
    marginTop: ParentSpace.md,
    alignSelf: 'stretch',
    backgroundColor: CampusColors.primary,
  ...
  finalsBtnText: { ...ParentType.bodyMd, fontFamily: CampusFonts.bodyBold, color: CampusColors.onPrimary },
});
