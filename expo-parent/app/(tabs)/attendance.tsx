...
const styles = StyleSheet.create({
  ...
  meta: { ...CampusType.bodyMd, color: CampusColors.onSurfaceVariant, marginTop: 4, marginBottom: CampusSpace.md },
  monthPicker: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  monthPickerText: { ...CampusType.bodyMd, fontFamily: CampusFonts.bodyBold },
  statGrid: { gap: CampusSpace.gutter, marginBottom: CampusSpace.xl },
  statCard: {
    backgroundColor: CampusColors.surfaceContainerLowest,
    borderRadius: CampusRadius.md,
  ...
  statTop: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: CampusSpace.sm },
  ...
  trendText: { ...CampusType.label, color: '#16a34a' },
  statLabel: { ...CampusType.label, color: CampusColors.onSurfaceVariant, letterSpacing: 0.6 },
  statValue: { ...CampusType.stat, color: CampusColors.onSurface, marginTop: 4 },
  calendarCard: {
    backgroundColor: CampusColors.surfaceContainerLowest,
    borderRadius: CampusRadius.md,
    padding: CampusSpace.gutter,
  ...
  calHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: CampusSpace.lg },
