  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView
        ...
        <Text style={[styles.sectionTitle, { marginTop: CampusSpace.lg }]}>Upcoming Dues</Text>
        <DueRow
          icon="event"
...
const styles = StyleSheet.create({
  ...
  pageTitle: { ...CampusType.h1, color: CampusColors.onSurface },
  subtitle: { ...CampusType.bodyMd, color: CampusColors.onSurfaceVariant, marginTop: 6, marginBottom: CampusSpace.lg },
  whiteCard: {
  ...
  cardKicker: { ...CampusType.label, color: CampusColors.onSurfaceVariant, letterSpacing: 0.8 },
  cardAmount: { ...CampusType.stat, color: CampusColors.onSurface, marginTop: 6 },
  cardFoot: { ...CampusType.caption, color: CampusColors.onSurfaceVariant, marginTop: 8 },
  ...
  progressPct: { ...CampusType.label, color: CampusColors.onSurfaceVariant, marginTop: 6, textAlign: 'right' },
  balanceCard: {
  ...
  balanceKicker: { ...CampusType.label, color: 'rgba(255,255,255,0.85)', letterSpacing: 0.8 },
  balanceAmt: { ...CampusType.stat, color: CampusColors.onPrimary, marginTop: 6 },
  payBtn: {
  ...
  payBtnText: { ...CampusType.bodyMd, fontFamily: CampusFonts.bodyBold, color: CampusColors.primary },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: CampusSpace.md },
  sectionTitle: { ...CampusType.h2, color: CampusColors.onSurface },
  ...
  th: { ...CampusType.label, color: CampusColors.onPrimaryFixedVariant, fontSize: 10 },
  tr: { flexDirection: 'row', paddingHorizontal: CampusSpace.md, paddingVertical: 14, alignItems: 'flex-start' },
  trBorder: { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: CampusColors.outlineVariant },
  td: { ...CampusType.caption, color: CampusColors.onSurface, fontSize: 12 },
  tdTitle: { fontFamily: CampusFonts.bodyBold, fontSize: 13, color: CampusColors.onSurface },
  tdSub: { ...CampusType.caption, color: CampusColors.onSurfaceVariant, marginTop: 2 },
  ...
  dueSub: { ...CampusType.caption, color: CampusColors.onSurfaceVariant, marginTop: 2 },
  ...
  helpKicker: { ...CampusType.label, color: CampusColors.onSurfaceVariant, letterSpacing: 0.8 },
  helpText: { ...CampusType.bodyMd, color: CampusColors.onSurface, marginTop: 8 },
  helpBtn: {
    marginTop: CampusSpace.lg,
    borderWidth: 1,
  ...
  helpBtnText: { ...CampusType.bodyMd, fontFamily: CampusFonts.bodyBold, color: CampusColors.primary },
});
